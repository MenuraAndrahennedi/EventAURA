...
// Import social media icon images for the footer
...
const SubFooter = () => {
    return (
        ...
        // Footer container with white text on dark background
        <footer className="text-white sub-footer bg-dark">
            <div className="container py-4 text-center">

                {/* Stay Updated Section - includes call-to-action links */}
                <div className="stay-updated">
                    ...
                    {/* Social media icons section, displayed in a flexible horizontal layout */}
                ...
                {/* Links Section with EventAURA and CODECATALYSTS information */}
                <div className="mt-4 footer-links row">

                     {/* EventAURA links and copyright */}
                    ...
                    {/* CODECATALYSTS links and copyright */}
                    <div className="mb-3 text-center col-md-6">
