                                ...
                                <div className="card-body profile-details">
                                    ...
                                    <div className="my-3 ">
                                        <div className="flex-wrap btn-group d-flex justify-content-center">
                                            <Link
                                                href={route(
                                                    "eventhost.ongoingEvents.history"
                                                )}
                                                className={`btn ${
                                                    location.pathname ===
                                                    "/event-host/profile"
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <button
                                                                ...
                                                                onClick={() =>
                                                                    handleDownload(
                                                                        `/event/selling-ticket-report/${event.id}`
                                                                    )
                                                                }
                                                            >
                                                                Download
                                                        ...
                                                        <td>
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() =>
                                                                    handleDownload(
                                                                        `/event/event-attendees-list/${event.id}`
                                                                    )
                                                                }
                                                            >
                                                                Download
